...
staxyz=[-2304501.4548,-3547589.3986,4757288.6268]; % XYZ of antenna (usually in header)
seasfc_rough=0.18; % estimate for synthetic SNR in metres
resln=0.1; % resolution of SNR data in dB-Hz
